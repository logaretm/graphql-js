...
export interface GraphQLChannels {
  ...
  subscribePerEventExecutor: MinimalTracingChannel;
}
...
/** @internal */
export const subscribePerEventExecutorChannel:
  | MinimalTracingChannel
  | undefined = dc?.tracingChannel('graphql:subscribe:perEventExecutor');
/** @internal */
